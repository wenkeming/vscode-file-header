/*
 * @Author: Kevin
 * @Date: 2018-02-02 12:51:36
 * @Last Modified time: 2018-02-02 12:51:36
 */
            ...
            try {
                ...
                for (var i = 0; i < lineCount; i++) {
                    ...
                    if (comment) {
                        ...
                        if (line.indexOf('@Last Modified time') > -1) { //最后修改时间
                            var time = line.replace('* @Last Modified time: ', '');
                ...
                if (diff > 20) {
                    setTimeout(function () {
                        editor.edit(function (edit) {
                            authorRange != null && edit.replace(authorRange, authorText);
                            lastTimeRange != null && edit.replace(lastTimeRange, lastTimeText);
                        });
                        document.save();
                    }, 200);
                }
